...
return {
    ...
    opts = function(_, opts)
      ...
      local has_eslint = function(util)
        return util.root_has_file ".eslintrc.js"
          ...
          or util.root_has_file ".eslintrc" -- This is the one change we add to the community Typescript config
  ...
  -- },
  -- Disabling simply because I haven't found a use for it yet
  -- {
